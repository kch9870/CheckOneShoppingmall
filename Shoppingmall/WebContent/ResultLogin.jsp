...
<body>
<body onload="window.open('images/best3.jpg','','width=420px, height=540px, left=100px, top=100px, toolbar=0, status=yes, menubars=0, scrollbars=0, resizable=0, location=0, directories=0')">
<div id="wrapper-bg">
	<div id="wrapper">
		<div id="header" class="container">
			...
			<div id="menu">
				<ul>
					<li class="active"><a href="Login.jsp" accesskey="1" title="">Welcome!</a></li>
		...
		<div id="three-column" class="container">
			<header>
				<h2>지금 가장 잘나가는BEST 5!</h2>
			</header>
			<div class="tbox1">
				<div class="box-style box-style01">
					<div class="content"> <a href="#" class="image image-full"><img src="images/product.jpg" alt=""></a>
						<h2>감귤밭 가디건</h2>
						<p>가격: 22000원 </p>
						<a href="Product.jsp" class="button-style">더보기</a> </div>
				</div>
			</div>
			<div class="tbox2">
	...
	<div id="three-column" class="container">
			...
			<div class="tbox2">
				<div class="box-style box-style02">
					<div class="content"> <a href="#" class="image image-full"><img src="images/best6.jpg" alt=""></a>
						<h2>Mauris vulputate dolor</h2>
						<p>Aliquam erat volutpat. Pellentesque tristique ante ut risus. Quisque dictum. Integer nisl risus, sagittis convallis, rutrum id, elementum congue, nibh. </p>
						<a href="#" class="button-style">Learn More</a> </div>
				</div>
			...
			<div class="tbox3">
				<div class="box-style box-style03">
					<div class="content"> <a href="#" class="image image-full"><img src="images/best7.jpg" alt=""></a>
						<h2>Nulla luctus eleifend </h2>
						<p>Aliquam erat volutpat. Pellentesque tristique ante ut risus. Quisque dictum. Integer nisl risus, sagittis convallis, rutrum id, elementum congue, nibh.</p>
						<a href="#" class="button-style">Learn More</a> </div>
				</div>
